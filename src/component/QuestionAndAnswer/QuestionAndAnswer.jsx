  ...
  return (
    <div>
      ...
      <div className="mt-8">
        ...
        <p className="font-semibold text-xl mt-4">
         <span className="font-bold ms-8">Ans: </span> React is a popular JavaScript library that is used to build user interfaces. React uses a virtual DOM to manage the state and rendering of components, which makes it efficient and fast. React works according to the following step- component rendering, virtual DOM, state management, event handling, performance optimizations.
        </p>
      </div>
